 ...
 <table class="w-full mt-2 text-gray-500">
        <thead class="border-b">
          ...
          <tr>
            ...
            <th class="text-right text-gray-600"><slot name="th6">HEADER6</slot></th>
          </tr>
        </thead>
        ...
        <tbody class="divide-y divide-gray-200">
          ...
          <tr v-for="user in users" :key="user.id">
            ...
            <td class="flex items-center py-4">
              ...
              <div class="px-4">
                <div>
                  <a href="#" class="text-gray-600 font-bolder">{{ user.name || "dag"}}</a>
                </div>
              </div>
            </td>
            ...
            <td>{{user.email}}</td>
            <td>{{user.createdDate.slice(0,10)}}
              </td>
            <td class="text-right">
